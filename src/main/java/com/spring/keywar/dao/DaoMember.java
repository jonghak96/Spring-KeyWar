...
public interface DaoMember {
	...
	public void writeGymDao(String gNumber, String gAddress, String cPhoto, String cPhotoPath, int gRentalPrice, String mId);
	...
	public void writGymFile(String cPhoto, String cPhotoPath, String mId);
