...
<style>
	...
	<br>
	 ...
	 <br>
	 이름 &emsp; ${content.mName }
	 <br>
	 성별 &emsp; ${content.cSex }
	 <br>
	 나이 &emsp; ${content.cAge }
	 <br>
	 지역 &emsp; ${content.mArea }
	 <br>
	 전적 &emsp; ${content.cWin } / ${content.cDraw } / ${content.cLose }
	 <br>
	 체급 &emsp; ${content.cHeight } / ${content.cWeight } / ${content.cwClass }
	 <br>
